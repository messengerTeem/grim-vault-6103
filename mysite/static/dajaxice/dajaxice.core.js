...
var Dajaxice = {
    ...
    multiply: function(callback_function, argv, custom_settings){
        return Dajaxice.call('messenger.multiply', 'POST', callback_function, argv, custom_settings);
    },

    sendMessage: function(callback_function, argv, custom_settings){
        return Dajaxice.call('messenger.sendMessage', 'POST', callback_function, argv, custom_settings);
    },

    sayhello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('messenger.sayhello', 'POST', callback_function, argv, custom_settings);
    },

    updateHistory: function(callback_function, argv, custom_settings){
